...
export default function AdminAirTickets() {
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="divide-y divide-gray-50">
            {loading ? <div className="h-32 animate-pulse bg-gray-50"/> : txs.map(tx => {
              let ticket = {};
            ...
            {!loading && txs.length===0 && <p className="text-center text-gray-400 text-sm py-8">No air ticket orders</p>}
          </div>
        </div>
      </div>
    </AdminShell>
